            ...
            <div id="JointSummary-main-box">
                <div id="JointSummary-box-1">
                    ...
                    <div id="Joint-Treatment-Options-box-2">
                        ...
                        <div>
                            <div id="Knee-Replacement-small-box-1" className="JPR-footer-box1" style={{ opacity: replacement === "Medial" ? 1 : 0.5 }}> Medial </div>

                            <div id="Knee-Replacement-small-box-1" className="JPR-footer-box2" style={{ opacity: replacement === "Lateral" ? 1 : 0.5 }}> Lateral </div>

                            <div id="Knee-Replacement-small-box-1" className="JPR-footer-box3" style={{ opacity: replacement === "Lateral" ? 1 : 0.5 }}> Kneecap </div>
                        </div>
                    </div>
                </div>
