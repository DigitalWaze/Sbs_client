...
class GetImage extends Component {
    ...
    render() { 
        return ( 
            <div className="GetImage" style={{width:"900px",height:"700px",backgroundColor:"white",position:'absolute',top:'-16384px'}}>
                        ...
                        <Grid container item xs={12} key={id}>
                            ...
                            type.xrays.map((xray,id)=>
                                ...
                                <React.Fragment key={id}>    
                                    ...
                                    <Grid item xs={2} style={{border:'1px solid #000000',height:`calc(${height} - 2px)` , background:xray.state==='Normal to Sight'?'#6C8D31':''}}>
                                        <div className="GetImage_Report_Box_Selected_Box"> {xray.state==='Normal to Sight' && <img src={Tick} alt="Ticked" /> } </div> 
                                    </Grid>
                                    <Grid item xs={2} style={{border:'1px solid #000000',height:`calc(${height} - 2px)`,background:xray.state==='Moderate'?'#FA9E2D':''}}>
                                        <div className="GetImage_Report_Box_Selected_Box"  > {xray.state==='Moderate' && <img src={Tick} alt="Ticked" /> }  </div> 
                                    </Grid>
                                    <Grid item xs={2} style={{border:'1px solid #000000',height:`calc(${height} - 2px)`,background:xray.state==='Severe'?'#C50000':''}}>
                                        <div className="GetImage_Report_Box_Selected_Box"> {xray.state==='Severe' && <img src={Tick} alt="Ticked" /> } </div> 
                                    </Grid>
                                    <Grid item xs={2} style={{border:'1px solid #000000',height:`calc(${height} - 2px)`,background:xray.state==='End Stage'?'#C50000':''}}>
                                        <div className="GetImage_Report_Box_Selected_Box"> {xray.state==='End Stage' && <img src={Tick} alt="Ticked" /> } </div> 
                                    </Grid>
                                </React.Fragment>
