...
class Routes extends Component {
    ...
    Logout = () =>
    {
        ...
        this.setState({old:false,tutorial:null,evaluation_stage:null,temp_report_id:null,temp_patient_id:null,joint_id:null,activePriority:null,Evaluations:[],Eval:[],loggedIn:false,token:null,type:null,user_id:null,user_email:null,user_type:null,organization:null})
    ...
    componentWillMount()
    {
        ...
        if(this.state.token==null || !this.state.token || this.state.token=="" || this.state.token==" ")
        {
            ...
            else
            {
                ...
                this.setState({old:false,evaluation_stage:evaluation_stage,temp_report_id:temp_report_id,temp_patient_id,temp_patient_id,loading:false,loggedIn:true,token:token,type:type,user_id:user_id,user_email:user_email,user_type:{id:user_type_id,type:user_type_name},organization:organization});
    ...
    clearLeft = () =>
    {
        ...
        this.setState({old:null,tutorial:null,evaluation_stage:null,temp_report_id:null,temp_patient_id:null});
    }
